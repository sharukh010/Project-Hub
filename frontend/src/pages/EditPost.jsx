...
//             Update your project explanation and details
//           </p>
//         </div>
...
function EditPost() {
  ...
  const editMutation = useMutation({
    mutationFn: (formData) => postsAPI.updatePost(id, formData),
    onSuccess: () => {
      toast.success('Post updated successfully!')
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Failed to load post for editing.</p>
        </div>
      </div>
    )
  }
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            {tags.map((tag, idx) => (
              <span key={idx} className="tag-blue">
                {tag}
                <button
                  type="button"
